        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">
                    <span style="color: #CD0100">About Us</span></h2>
...
<section class="features8 cid-rc6rW7lkfc mbr-parallax-background" id="features8-f">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-7">
                        <h4 style="color: #000000">The School's History</h4>
                    </h4>
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-7">
                        <h4 style="color: #000000">Secretarial Skills</h4>
                    </h4>
                    <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-7">
                        <h4 style="color: #000000">Girlchild Education Priority</h4>
                    </h4>
                    <p class="mbr-text mbr-fonts-style display-7">

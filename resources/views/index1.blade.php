...
<header class="header navbar fixed-top navbar-expand-md">
    <div class="container">
        <a class="navbar-brand logo" href="#">
            <img class="img-fluid" src="{{asset ('assets/images/logoz.png')}}" alt="Evento" style="width: 100px; height: 100px;" />
        </a>
...
<section id="home" class="home-cover">
    <div class="cover_slider owl-carousel owl-theme">
        <div class="cover_item" style="background: url('assets/images/Picture6a.png');">
        ...
        <div class="cover_item" style="background: url('assets/images/Picture1.png');">
            <div class="slider_content">
                <div class="slider-content-inner">
                    <div class="container">
        ...
        <div class="cover_item" style="background: url('assets/images/Picture4.png');">
            <div class="slider_content">
                <div class="slider-content-inner">
                    <div class="container">
                        <div class="slider-content-center">
...
<section class="pb100">
    ...
    <div class="row justify-content-center no-gutters">
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s1.png')}}" alt="speaker name">
                    <div class="info_box">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s2.png')}}" alt="speaker name">
                    <div class="info_box">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s3.png')}}" alt="speaker name">
                    <div class="info_box">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s4.png')}}" alt="speaker name">
                    <div class="info_box">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s5.png')}}" alt="speaker name">
                    <div class="info_box">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s6.png')}}" alt="speaker name">
                    <div class="info_box">
                        <h5 class="name">Patricia Stone</h5>
                        <p class="position">CEO Company</p>
                    </div>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s7.png')}}" alt="speaker name">
                    <div class="info_box">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="speaker_box">
                <div class="speaker_img">
                    <img src="{{asset ('assets/img/speakers/s8.png')}}" alt="speaker name">
                    <div class="info_box">
                        <h5 class="name">Patricia Stone</h5>
                        <p class="position">CEO Company</p>
                    </div>
    ...
    <div class="container">
        <div class="table-responsive">
            <table class="event_calender table">
                ...
                <tr>
                    <td>
                        <img src="{{asset ('assets/img/cleander/c1.png')}}" alt="event">
                    </td>
                    <td class="event_date">
                        14
                        <span>February</span>
                ...
                <tr>
                    <td>
                        <img src="{{asset ('assets/img/cleander/c3.png')}}" alt="event">
                   </td>
                    <td class="event_date">
                        22
                        <span>February</span>
